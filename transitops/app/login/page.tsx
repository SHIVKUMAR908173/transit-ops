      ...
      <div className="hidden lg:flex w-1/2 bg-gray-900 text-white flex-col justify-between p-12">
        ...
        <div className="border-t border-gray-800 pt-8 mt-12">
          <blockquote className="text-base text-gray-400 italic">
            "TransitOps transformed our dispatch pipeline. We cut down dispatch errors to zero within the first week."
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <form action={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div className="bg-red-50 text-red-600 px-4 py-3 rounded-lg text-sm border border-red-100 flex items-start gap-3">
